...
class AuthProvider extends ChangeNotifier {
  ...
  AuthProvider(this._mongoService);
  ...
  Future<bool> login(String email, String password) async {
    ...
    try {
      final user = await _mongoService
          .getUserProfile(email); // Assuming email is used as ID
  ...
  Future<bool> register(String name, String email, String password) async {
    ...
    try {
      ...
      await _mongoService.createUserProfile(user);
      _currentUser = user;
      _isLoading = false;
      notifyListeners();
      return true;
  ...
  Future<void> updateProfile({
    ...
    try {
      ...
      await _mongoService.updateUserProfile(_currentUser!.id, updates);
  ...
  Future<void> addEmergencyContact(String name, String phone) async {
    ...
    try {
      final contactId = await _mongoService.addEmergencyContact(
        _currentUser!.id,
        name,
        phone,
      );
  ...
  Future<void> removeEmergencyContact(String id) async {
    ...
    try {
      await _mongoService.removeEmergencyContact(_currentUser!.id, id);
  ...
  Future<bool> checkCurrentUser() async {
    try {
      // Implement logic to check if user is already logged in
      return false;
    } catch (e) {
      _error = e.toString();
      notifyListeners();
